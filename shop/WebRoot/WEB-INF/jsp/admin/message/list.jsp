	...
	<table cellSpacing="1" cellPadding="0" width="100%" align="center"
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" >${message.messagedate}</td>
									 <td align="center" style="HEIGHT: 22px"  >
										 <a href="${ pageContext.request.contextPath }/admin/adminMessage_delete.action?messageid=${message.messageid}">
		...
		<tr align="center">
			<td >第 ${pageBean.page }/${pageBean.totlePage}页 <c:if test="${pageBean.page!= 1}">
					<a
						href="${pageContext.request.contextPath }/admin/adminMessage_findAllByPage.action?page=1">首页</a>|
			     	<a
						href="${pageContext.request.contextPath }/admin/adminMessage_findAllByPage.action?page=${pageBean.page-1}">上一页</a>
				</c:if>
				 <c:forEach begin="1" end="${pageBean.totlePage}" var="i">
					<c:choose>
						<c:when test="${pageBean.page!=i}">
							<a href="${ pageContext.request.contextPath }/admin/adminMessage_findAllByPage.action?page=${i}">${i}</a>
						</c:when>
						<c:otherwise>
				...
				<c:if test="${pageBean.page!=pageBean.totlePage}">
					<a
						href="${pageContext.request.contextPath }/admin/adminMessage_findAllByPage.action?page=${pageBean.page+1}">下一页</a> |
							<a
						href="${pageContext.request.contextPath }/admin/adminMessage_findAllByPage.action?page=${pageBean.totlePage}">尾页</a>
				</c:if>
			</td>
		</tr>
	</table>
